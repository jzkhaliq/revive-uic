...
export default function Mentorship() {
    return (
        <motion.section
            id="mentorship"
            className="bg-white text-revive-brown scroll-mt-20"
        ...
        >
            <div className="max-w-6xl mx-auto px-6 py-16">
                ...
                <div className="grid md:grid-cols-3 gap-6 mt-8">
                    <motion.div
                        className="rounded-xl border border-revive-tan bg-revive-cream/60 p-6"
                    ...
                    <motion.div
                        className="rounded-xl border border-revive-tan bg-white/70 p-6"
                        whileHover={{ scale: 1.01 }}
                    >
